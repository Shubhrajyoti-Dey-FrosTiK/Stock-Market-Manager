...
public class PastTransactionGUI extends JFrame {
...
//	}
	 ...
	 * Create the frame.
	 */
	public PastTransactionGUI(CustomerInfo data) {
		...
		String Read = SF.showFile(Path.AbsPath() + "src/CustomerDataFiles/" + data.AadharNo + ".txt");
